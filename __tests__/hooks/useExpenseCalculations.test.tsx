...
describe('useExpenseCalculations', () => {
  ...
  const mockGroups = [
    { id: 'group-1', name: 'Trip to Paris', createdBy: 'user-1', date: '2023-07-01T12:00:00Z', description: 'Our summer trip' },
    { id: 'group-2', name: 'Apartment', createdBy: 'user-2', date: '2023-07-02T12:00:00Z', description: 'Apartment expenses' },
  ];
